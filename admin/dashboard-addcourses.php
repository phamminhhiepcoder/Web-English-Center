	...
	<div id="header" class="not-sticky">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a th:href="@{/dashboard}"><img src="images/logo.png" alt=""></a>
					<a th:href="@{/dashboard}" class="dashboard-logo"><img
			...
			<div class="right-side">
				...
				<div class="header-widget">
					...
					<div class="user-menu">
						...
						<ul>
							...
							<li><a th:href="@{/dashboard-orders}"><i
									class="fa fa-calendar-check-o"></i> Payments</a></li>
					...
					<a th:href="@{/dashboard-addproduct}"
						class="button border with-icon">Add Film<i
					...
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Products">
							<li><a th:href="@{/dashboard-myproducts}"><i
									class="sl sl-icon-layers"></i> Banner</a></li>
							<li><a th:href="@{/dashboard-addproduct}"><i
									class="sl sl-icon-plus"></i> Add Banner</a></li>
						</ul>
	
						<ul data-submenu-title="Products">
							<li><a th:href="@{/dashboard-myproducts}"><i
									class="sl sl-icon-layers"></i> Film Category</a></li>
							<li><a th:href="@{/dashboard-addproduct}"><i
									class="sl sl-icon-plus"></i> Add Category</a></li>
						</ul>
	
						<ul data-submenu-title="Products">
							<li><a th:href="@{/dashboard-myproducts}"><i
									class="sl sl-icon-layers"></i> Film</a></li>
							<li><a th:href="@{/dashboard-addproduct}"><i
									class="sl sl-icon-plus"></i> Add Film</a></li>
						</ul>
	
						<ul data-submenu-title="Users">
							<li><a th:href="@{/dashboard-users}"><i
									class="sl sl-icon-user"></i> List Users</a></li>
						</ul>
